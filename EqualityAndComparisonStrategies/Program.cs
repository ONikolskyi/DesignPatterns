namespace EqualityAndComparisonStrategies
{
    public class Person : IComparable<Person>, IComparable
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            return obj is Person other ? CompareTo(other) : throw new ArgumentException(nameof(obj));
        }
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            people.Sort(); // default sort strategy
            //people.Sort((x, y) => x.Name.CompareTo(y.Name)); // strategy provided by lambda
            people.Sort(Person.NameComparer); // sort by name
        }
    }
}